    ...
    <section className="py-32 bg-background relative flex items-center justify-center overflow-hidden">
      <div className="container max-w-5xl px-6 relative z-10">
        ...
        <button
          ...
          type="button"
          className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 lg:-translate-x-20 w-12 h-12 rounded-full border border-border flex items-center justify-center text-foreground hover:bg-white/10 transition-colors z-20"
        ...
        <button
          ...
          type="button"
          className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 lg:translate-x-20 w-12 h-12 rounded-full border border-border flex items-center justify-center text-foreground hover:bg-white/10 transition-colors z-20"
        ...
        <div className="text-center space-y-12 transition-opacity duration-500 ease-in-out">
          ...
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-3 bg-white/5 backdrop-blur-md rounded-full px-2 py-2 pr-6 border border-border">
              <img
