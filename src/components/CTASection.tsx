      ...
      <div className="container max-w-6xl relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end relative isolate">
          <div className="absolute inset-0 hidden md:block">
            <div className="absolute h-2 rounded-full bg-linear-to-r to-white via-white rotate-25 z-10 w-300 mix-blend-soft-light blur-[2px] -left-211 transform-gpu-blur"></div>
            <div className="absolute w-300 h-100 rotate-25 -top-80 -right-4 overflow-hidden">
              <div className="absolute size-100 rounded-full bg-primary2 z-10 -bottom-80 left-1/2 -translate-x-1/2 blur-[130px] blur-min"></div>
            </div>

            <div className="absolute h-2 rounded-full bg-linear-to-l to-white via-white rotate-25 top-99 z-10 w-300 mix-blend-soft-light blur-[2px] transform-gpu-blur"></div>
            <div className="absolute w-250 h-100 rotate-25 top-94 left-0 overflow-hidden">
              <div className="absolute size-100 rounded-full bg-[#4661BE] z-10 -top-90 left-1/2 -translate-x-1/2 blur-[130px] blur-min"></div>
            </div>
          </div>
