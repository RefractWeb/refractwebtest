        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:auto-rows-[350px]">
          ...
          >
            ...
            <Image
              ...
              className="object-cover opacity-60 md:opacity-100 group-hover:scale-105 transition-all duration-700 absolute top-4 left-1/2 -translate-x-1/2 md:right-[-12%] md:top-[-6%] w-auto h-36 xs:h-52 sm:h-64 md:h-75 pointer-events-none select-none rounded-2xl overflow-hidden"
            />
          </motion.div>
