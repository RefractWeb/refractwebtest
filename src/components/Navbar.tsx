...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-4 md:top-8 px-6 z-100 w-full flex justify-between items-center">
      ...
      {/* Desktop Pill Menu */}
      <div className="absolute left-1/2 -translate-x-1/2 hidden md:flex bg-linear-to-b from-white/5 to-white/10 backdrop-saturate-180 backdrop-brightness-120 -lg border border-white/5 border-b-white/20 rounded-full p-2 items-center gap-8 shadow-xl shadow-black/10 blur-gpu">
        <Link href="/">
          <div className="button h-9">
            <span>
              <Image
      ...
      <div className="ml-auto flex items-center gap-3 relative z-70">
        ...
        <button
          ...
          className="md:hidden flex items-center justify-center size-10 rounded-full bg-white/5 -xl border border-white/10 text-white transition-all active:scale-95 hover:bg-white/10 blur-gpu"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-background z-60 md:hidden flex flex-col"
          >
