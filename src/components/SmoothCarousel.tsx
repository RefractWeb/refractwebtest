          ...
          <div className="flex justify-between items-center w-full">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="size-9 flex items-center justify-center rounded-full bg-linear-to-br from-background to-card border border-border/20 hover:brightness-125 transition-all active:scale-97 disabled:opacity-50 disabled:cursor-not-allowed text-secondary-foreground cursor-pointer"
                type="button"
